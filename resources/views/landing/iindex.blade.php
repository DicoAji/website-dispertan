...
@section('content')
    ...
    <!-- STATISTIK -->
    <section class="bg-primary-light py-6 md:py-8">
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 text-center">
                <div
                    class="bg-green-50 p-3 md:p-5 shadow-sm rounded-xl border border-green-100 flex flex-col justify-center transition hover:scale-105">
                ...
                <div
                    class="bg-blue-50 p-3 md:p-5 shadow-sm rounded-xl border border-blue-100 flex flex-col justify-center transition hover:scale-105">
                ...
                <div
                    class="bg-amber-50 p-3 md:p-5 shadow-sm rounded-xl border border-amber-100 flex flex-col justify-center transition hover:scale-105">
                ...
                <div
                    class="bg-indigo-50 p-3 md:p-5 shadow-sm rounded-xl border border-indigo-100 flex flex-col justify-center transition hover:scale-105">
