    ...
    <section class="">
        <div class="container mx-auto px-4 max-w-6xl space-y-8">
            <div class="text-center">
                <h2 class="text-2xl font-bold text-gray-900 mb-2">Visi dan Misi</h2>
            ...
            <div class="w-full mx-auto  overflow-hidden mb-4">
                <button onclick="toggleDropdown('visi-content', 'visi-icon')"
                    ...
                    <h3 class="text-xl  ps-2 font-bold text-green-700 uppercase">Visi</h3>
            ...
            <div class="">
                <button onclick="toggleDropdown('misi-content', 'misi-icon')"
                    ...
                    <h3 class="text-xl ps-2 font-bold text-green-700 uppercase">Misi</h3>
