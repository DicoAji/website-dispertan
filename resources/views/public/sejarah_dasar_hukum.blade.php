...
@section('content')
    <section class="pt-12">
        <div class="container mx-auto px-4 max-w-7xl space-y-8">
            ...
            @php
                // Memanggil data langsung dari database di dalam Blade untuk ID = 15
                $sejarahDasarHukum = \App\Models\FileDinas::find(15);
            @endphp

            <div class="p-4 md:p-8 shadow-lg border rounded-lg bg-white mt-8">
                @if ($sejarahDasarHukum && $sejarahDasarHukum->file)
                    {{-- Info Dokumen --}}
                ...
                @else
                    ...
                    <div class="text-center py-20 text-gray-400">
                        ...
                        <p class="text-lg">Dokumen sejarah dan dasar hukum belum tersedia.</p>
                    </div>
                @endif
            </div>
