...
@section('title', 'Bidang Sekretariat')

@section('content')
<div class="container mx-auto px-4 py-12 max-w-5xl">
    <div class="text-center mb-10">
        <h1 class="text-3xl md:text-4xl font-bold text-emerald-800 mb-4">Bidang Sekretariat</h1>
        <div class="w-24 h-1 bg-emerald-500 mx-auto rounded-full"></div>
    </div>

    <div class="space-y-6">
        @forelse ($bidang as $item)
        <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden border border-gray-200 flex flex-col md:flex-row">
            ...
            <div class="md:w-1/3 lg:w-1/4 shrink-0 bg-gray-50 border-b md:border-b-0 md:border-r border-gray-100">
                ...
                @else
                <div class="w-full h-56 md:h-64 flex flex-col items-center justify-center text-gray-400">
                    <i class="fa-solid fa-building-user text-4xl mb-2 text-emerald-200"></i>
        ...
        <div class="text-center py-16 bg-gray-50 rounded-2xl border border-dashed border-gray-300">
            ...
            <p class="text-gray-500 mt-2">Data untuk Bidang Sekretariat belum tersedia saat ini.</p>
        </div>
        @endforelse
    </div>
</div>
