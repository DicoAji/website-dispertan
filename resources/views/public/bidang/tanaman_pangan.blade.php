...
@section('title', 'Bidang Tanaman Pangan')

@section('content')
    <div class="container mx-auto px-4 py-12 max-w-5xl">
        <div class="text-center mb-10">
            <h1 class="text-3xl md:text-4xl font-bold text-emerald-800 mb-4">Bidang Tanaman Pangan</h1>
        ...
        <div class="space-y-6">
                    ...
                    <div class="md:w-1/3 lg:w-1/4 shrink-0 bg-gray-50 border-b md:border-b-0 md:border-r border-gray-100">
                        ...
                        @else
                            <div class="w-full h-56 md:h-full flex flex-col items-center justify-center text-gray-400">
                                <i class="fa-solid fa-image text-4xl mb-2 text-emerald-200"></i>
            ...
            @empty
                <div class="text-center py-16 bg-gray-50 rounded-2xl border border-dashed border-gray-300">
                    ...
                    <p class="text-gray-500 mt-2">Data untuk Bidang Tanaman Pangan belum tersedia saat ini.</p>
                </div>
            @endforelse
        </div>
    </div>
